...
CREATE TABLE `bill_of_material` (
  ...
  `Raw_Material_Quantity_Needed` int(11) NOT NULL,
  PRIMARY KEY (`ID`,`ProductID`,`Raw_MaterialID`)
...
INSERT INTO `bill_of_material` VALUES (1,1,1,40),(2,1,2,30);
...
-- Dump completed on 2022-11-20 11:51:00
