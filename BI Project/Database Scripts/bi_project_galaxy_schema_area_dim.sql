...
--
-- Table structure for table `area_dim`
--
...
CREATE TABLE `area_dim` (
  `Area_Key` int(11) NOT NULL AUTO_INCREMENT,
  `ID` int(11) NOT NULL,
...
--
-- Dumping data for table `area_dim`
--

LOCK TABLES `area_dim` WRITE;
/*!40000 ALTER TABLE `area_dim` DISABLE KEYS */;
/*!40000 ALTER TABLE `area_dim` ENABLE KEYS */;
UNLOCK TABLES;
